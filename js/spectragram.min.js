	...
	var Instagram = {
        ...
        displayPhotos: function ( results ) {
			...
			for ( var i = 0; i < max; i++ ) {
				...
				isImage = ["IMAGE", "CAROUSEL_ALBUM"].includes(results.data[i].media_type);
				...
				if (isImage) {
					...
					$element = `<div class="col-sm-12 col-md ftco-animate">
					    <a href="${results.data[i].media_url}" class="insta-img image-popup" style="background-image: url('${results.data[i].media_url}');">
